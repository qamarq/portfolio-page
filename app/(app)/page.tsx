                        ...
                        <div className="p-8 row-span-2 flex items-center justify-center relative horizontal-line bg-background/40 backdrop-blur-sm">
                            <div className="w-full flex flex-col gap-2">
                                ...
                                <div className="flex items-center gap-2 mt-4">
                                    <Badge variant={"default"}><Icons.Next className="w-3 h-3 mr-1.5" /> NextJS</Badge>
                                    <Badge variant={"secondary"}><Icons.Android className="w-3 h-3 mr-1.5" /> Android</Badge>
                                    <Badge variant={"outline"}><Icons.OpenAI className="w-3 h-3 mr-1.5" /> AI</Badge>
                                    <Badge variant={"outline"}><Icons.Fivem className="w-3 h-3 mr-1.5" /> FiveM</Badge>
                                </div>
                            </div>
                        </div>
