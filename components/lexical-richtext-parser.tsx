...
interface ElementProps {
    ...
    direction: "ltr" | "rtl"
    type: "paragraph" | "heading" | "text" | "quote" | "horizontalrule" | "link" | "upload" | "linebreak" | "list" | "listitem" | "block" | "autolink"
...
const Element = ({ childrens }: { childrens: ElementProps[] }) => {
    ...
    return childrens.map((child) => {
        ...
        const formattingStates: Record<keyof typeof states, boolean> = getFormattingStates(formatToProvide);
